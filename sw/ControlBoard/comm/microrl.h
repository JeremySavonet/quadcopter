...
extern "C" {
  ...
  void microrl_init (microrl_t * _this, void (*print)(const char*));
  ...
  #ifdef _USE_CTLR_C
  void microrl_set_sigint_callback (microrl_t * _this, void (*sigintf)(struct microrl_t * this));
  #endif

  // insert char to cmdline (for example call in usart RX interrupt)
  void microrl_insert_char (microrl_t * _this, int ch);
#ifdef __cplusplus
}
#endif
